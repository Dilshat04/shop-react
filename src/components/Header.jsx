...
const Header = () => {
  return (
    ...
    <header className=" items-center bg-white  shadow-lg h-24 hidden md:flex">
    
   
    
    
      <NavLink to="/" className="  border flex-shrink-0 flex items-center justify-center px-4 lg:px-6 xl:px-8">
      ...
      <div className="border flex items-center px-4 lg:px-6 xl:px-8">
        ...
        <button className="bg-black hover:bg-gray-700 text-white font-bold px-4 xl:px-6 py-2 xl:py-3 rounded">Sign up</button>
      </div>
    </header>
  )
}
